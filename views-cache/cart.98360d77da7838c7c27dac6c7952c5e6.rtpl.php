                                ...
                                <tbody>
                                    ...
                                    <tr class="cart_item">
                                        <td class="product-remove">
                                            ...
                                            href="/cart/<?php echo htmlspecialchars( $value1["idproduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/remove">×</a> 
                                        </td>
                                    ...
                                    <table cellspacing="0">
                                        <tbody>
                                            ...
                                            <tr class="shipping">
                                                ...
                                                <?php if( $cart["nrdays"] != '' ){ ?> 
                                                <small>
                                                prazo de <?php echo htmlspecialchars( $cart["nrdays"], ENT_COMPAT, 'UTF-8', FALSE ); ?> dia(s)</small>
                                                <?php } ?>
                                            ...
                                            <tr class="order-total">
                                                <th>Total</th>
                                                <td><strong>
                                                <span class="amount">R$<?php echo formatPrice($cart["vltotal"]); ?>
