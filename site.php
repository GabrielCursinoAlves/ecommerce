...
$app->post("/register",function(){
   ...
   if(User::checkLoginExist($_POST['email']) === true){
      ...
      User::setErrorRegister("Este endereço de e-mail já esta sendo usado por 
      outro usuário.");
      header('Location: /login');
      exit;
...
$app->post("/profile",function(){
   ...
   if($_POST['desemail'] !== $user->getdesemail()){
      ...
      if(User::checkLoginExist($_POST['desemail']) === true){
         ...
         User::setError("Este endereço e-mail já está cadastrado.");
         header("Location: /profile");
         exit;
...
$app->get("/boleto/:idorder",function($idorder){
   ...
   .$order->desstate()." - ".$order->getdescountry()." - CEP: ".
   $order->getdeszipcode();

   // INFORMACOES PARA O CLIENTE
   $dadosboleto["demonstrativo1"] = "Pagamento de Compra na Loja Hcode
   E-commerce";
   $dadosboleto["demonstrativo2"] = "Taxa bancária - R$ 0,00";
   $dadosboleto["demonstrativo3"] = "";
   $dadosboleto["instrucoes1"] = "- Sr. Caixa, cobrar multa de 2% após 
   o vencimento";
   $dadosboleto["instrucoes2"] = "- Receber até 10 dias após o vencimento";
   $dadosboleto["instrucoes3"] = "- Em caso de dúvidas entre em contato 
   conosco: suporte@hcode.com.br";
   $dadosboleto["instrucoes4"] = "&nbsp; Emitido pelo sistema Projeto 
   Loja Hcode E-commerce - www.hcode.com.br";
   ...
   $path = $_SERVER['DOCUMENT_ROOT'].DIRECTORY_SEPARATOR."res".
